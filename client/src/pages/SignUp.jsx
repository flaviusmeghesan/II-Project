  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        <input type = "text" placeholder = 'username' className='p-3 border border-gray-300 rounded-lg my-2' id='username' onChange={handleChange}/>
        ...
        <button disabled = {loading} className='bg-green-500 text-white p-3 rounded-lg hover:opacity-95 disabled:opacity-80'>{loading ? 'Loading...' : 'Sign Up'}</button>
      </form>
